AI Agent is a personal project using boot.dev guided tutorial.
...
Curret hard coded working directory is the calculator directory in the project itself. This is to prevent the Agent from changing the working directory and from changing unexpected files.
